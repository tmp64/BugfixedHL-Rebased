#ifndef ISURFACECOMPAT_H
#define ISURFACECOMPAT_H
...
class ISurfaceCompat : public IBaseInterface //public IAppSystem
{
public:
	static constexpr char VERSION[] = "VGUI_Surface026";
	...
	virtual bool SupportsFeature(ISurface::SurfaceFeature_e feature) = 0;
